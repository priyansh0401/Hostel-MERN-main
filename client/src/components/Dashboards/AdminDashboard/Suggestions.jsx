...
function Suggestions() {
  const getSuggestions = async () => {
    ...
    const response = await fetch("https://hostel-mern-main-backend.vercel.app/api/suggestion/hostel", {
      method: "POST",
      headers: {
  ...
  const updateSuggestion = async (id) => {
    setLoader(true);
    const response = await fetch("https://hostel-mern-main-backend.vercel.app/api/suggestion/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
