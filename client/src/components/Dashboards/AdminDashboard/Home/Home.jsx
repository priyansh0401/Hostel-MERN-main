...
function Home() {
  ...
  const getComplaints = async () => {
    ...
    const response = await fetch(`https://hostel-mern-main-backend.vercel.app/api/complaint/hostel`, {
      method: "POST",
      headers: {
  ...
  const getSuggestions = async () => {
    ...
    const response = await fetch(
      "https://hostel-mern-main-backend.vercel.app/api/suggestion/hostel",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const getRequests = async () => {
    const hostel = JSON.parse(localStorage.getItem("hostel"));
    const res = await fetch("https://hostel-mern-main-backend.vercel.app/api/messoff/list", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
