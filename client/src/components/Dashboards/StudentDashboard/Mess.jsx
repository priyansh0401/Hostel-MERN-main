...
function Mess() {
  let requestMessOff = async (event) => {
    ...
    let response = await fetch("https://hostel-mern-main-backend.vercel.app/api/Messoff/request", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    if (student) {
      fetch("https://hostel-mern-main-backend.vercel.app/api/Messoff/count", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
