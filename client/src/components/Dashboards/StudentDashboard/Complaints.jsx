...
function Complaints() {
  ...
  const registerComplaint = async (e) => {
    ...
    const res = await fetch("https://hostel-mern-main-backend.vercel.app/api/complaint/register", {
      method: "POST",
      headers: {
  ...
  useEffect(()=> {
    ...
    const fetchComplaints = async () => {
      const res = await fetch("https://hostel-mern-main-backend.vercel.app/api/complaint/student", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
